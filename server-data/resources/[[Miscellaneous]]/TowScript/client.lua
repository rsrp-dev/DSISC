...
local allowedTowModels = { 
    ...
    ['flatbed4'] = {x = 0.0, y = -1.2, z = 0.90}, -- addon flatbed3
    ['ctrailer'] = {x = 0.0, y = -0.6, z = 0.00}, -- addon Enclosed car trailer
    --['pjtrailer'] = {x = 0.0, y = 1.2, z = 0.75}, -- addon Goose Neck trailer
    --['cartrailer'] = {x = 0.0, y = -0.6, z = 0.00}, -- addon Open Car trailer
}
