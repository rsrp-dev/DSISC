    ...
    while true do
        ...
        if veh ~= nil then
            if GetVehicleClass(veh) == 1 or 2 or 3 or 4 or 5 or 6 or 7 or 8 or 9 or 12 or 18 or 20 or 21 then --if GetDisplayNameFromVehicleModel(GetEntityModel(veh)) == "a80" or "sc300" or "is300" or "mrx7" or "nis13" then
				...
				if GetDisplayNameFromVehicleModel(GetEntityModel(trailerLoc)) == "Car Hauler3" then
                    if IsEntityAttached(veh) then -- Is vehicle already attached?
                        ...
                        if IsControlJustReleased(1, attachKey) then -- Attach
							AttachEntityToEntity(veh, trailerLoc, 20, 0.0, -1.0, 0.65, 0.0, 0.0, 0.0, false, false, true, false, 20, true)
				...
				elseif GetDisplayNameFromVehicleModel(GetEntityModel(trailerLoc)) == "PJGooseneck" then
                    if IsEntityAttached(veh) then -- Is vehicle already attached?
                        if IsControlJustReleased(1, attachKey) then -- detach
							DetachEntity(veh, false, true)
						end
                        ...
                        if IsControlJustReleased(1, attachKey) then -- Attach
							AttachEntityToEntity(veh, trailerLoc, 20, 0.0, 0.0, 0.35, 0.0, 0.0, 0.0, false, false, true, false, 20, true)
							TaskLeaveVehicle(ped, veh, 64)	--   ( ? , z ,  X  ,   y  , 
                        end
                        -- Start Prompt
                        Citizen.InvokeNative(0x8509B634FBE7DA11, "STRING") -- BeginTextCommandDisplayHelp()
				...
				elseif GetDisplayNameFromVehicleModel(GetEntityModel(trailerLoc)) == "Car Hauler5" then
                    if IsEntityAttached(veh) then -- Is vehicle already attached?
                        if IsControlJustReleased(1, attachKey) then -- detach
							DetachEntity(veh, false, true)
						end
                        ...
                        if IsControlJustReleased(1, attachKey) then -- Attach
							AttachEntityToEntity(veh, trailerLoc, 20, 0.02, -0.95, 0.1, 0.0, 0.0, 0.0, false, false, true, false, 20, true)
							TaskLeaveVehicle(ped, veh, 64)	--   ( ? , z ,  X  ,   y  , 
                        end
                        -- Start Prompt
                        Citizen.InvokeNative(0x8509B634FBE7DA11, "STRING") -- BeginTextCommandDisplayHelp()
				...
				elseif GetDisplayNameFromVehicleModel(GetEntityModel(trailerLoc)) == "Car Hauler4" then
                    if IsEntityAttached(veh) then -- Is vehicle already attached?
                        if IsControlJustReleased(1, attachKey) then -- detach
							DetachEntity(veh, false, true)
						end
                        ...
                        if IsControlJustReleased(1, attachKey) then -- Attach
							AttachEntityToEntity(veh, trailerLoc, 20, 1.30, -3.0, 0.5, 0.0, 0.0, 0.0, false, false, true, false, 20, true)
							TaskLeaveVehicle(ped, veh, 64)	--   ( ? , z ,  X  ,   y  , 
                        end
                        -- Start Prompt
                        Citizen.InvokeNative(0x8509B634FBE7DA11, "STRING") -- BeginTextCommandDisplayHelp()
				...
				elseif GetDisplayNameFromVehicleModel(GetEntityModel(trailerLoc)) == "Car Hauler2" then
                    if IsEntityAttached(veh) then -- Is vehicle already attached?
                        if IsControlJustReleased(1, attachKey) then -- detach
							DetachEntity(veh, false, true)
						end
                        ...
                        if IsControlJustReleased(1, attachKey) then -- Attach
							AttachEntityToEntity(veh, trailerLoc, 20, -1.50, 3.0, 0.50, 0.0, 0.0, 0.0, false, false, true, false, 20, true)
							TaskLeaveVehicle(ped, veh, 64)	--   ( ? , z ,  X  ,   y  , 
                        end
                        -- Start Prompt
                        Citizen.InvokeNative(0x8509B634FBE7DA11, "STRING") -- BeginTextCommandDisplayHelp()
				...
				elseif GetDisplayNameFromVehicleModel(GetEntityModel(trailerLoc)) == "EagerBeaver" then
                    if IsEntityAttached(veh) then -- Is vehicle already attached?
                        if IsControlJustReleased(1, attachKey) then -- detach
							DetachEntity(veh, false, true)
						end
                        ...
                        if IsControlJustReleased(1, attachKey) then -- Attach
							AttachEntityToEntity(veh, trailerLoc, 20, 0.0, 0.0, 0.62, 0.0, 0.0, 0.0, false, false, true, false, 20, true)
							TaskLeaveVehicle(ped, veh, 64)	--   ( ? , z ,  X  ,   y  , 
                        end
                        -- Start Prompt
                        Citizen.InvokeNative(0x8509B634FBE7DA11, "STRING") -- BeginTextCommandDisplayHelp()
				...
				elseif GetDisplayNameFromVehicleModel(GetEntityModel(trailerLoc)) == "Car Hauler" then
                    if IsEntityAttached(veh) then -- Is vehicle already attached?
                        if IsControlJustReleased(1, attachKey) then -- detach
							DetachEntity(veh, false, true)
						end
                        ...
                        if IsControlJustReleased(1, attachKey) then -- Attach
							AttachEntityToEntity(veh, trailerLoc, 0, 0.0, -1.8, -0.075, 0.0, 0.0, 0.0, false, false, true, false, 20, true)
							TaskLeaveVehicle(ped, veh, 64)	--   ( ? , z ,  X  ,   y  , 
                        end
                        -- Start Prompt
                        Citizen.InvokeNative(0x8509B634FBE7DA11, "STRING") -- BeginTextCommandDisplayHelp()
